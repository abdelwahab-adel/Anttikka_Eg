  ...
  /* ---------- Category tabs product data ---------- */
   var categoryData = {
    sofas: [
      ...
      { img: 'images/prodact/كرسي بيرش المنجّد.png', cat: 'كراسي', name: 'كرسي بيرش المنجّد', price: '2,050', shopGrid, off: '20%', desc: 'كرسي منجّد بخطوط دائرية ناعمة، حشوة سخية ومسند ظهر مريح، يضيف لمسة دافئة لأي ركن جلوس أو غرفة قراءة.' },
    ...
    bedrooms: [
      ...
      { img: 'images/دريسنج3.jpg', cat: 'غرف نوم', name: 'دريسنج روم مودرن SZH3', price: '10,999', old: '56,000', off: '20%', desc: 'دريسنج روم مودرن بتصميم أسود جريء وتقسيمات تخزين ذكية، قطعة تعكس أناقة مساحتك بفخامة.' },
      ...
      { img: 'images/dr2.webp', cat: 'غرف نوم', name: 'دريسنج روم بلاك SZH1', price: '8,499', old: '38,400', off: '15%', desc: 'دريسنج روم بلاك بمزيج من دفء الخشب وفخامة الزجاج، تصميم مقسّم بذكاء لمساحة هادئة ومنظمة.' }
    ],
    dining: [
    ...
    lighting: [
      ...
      { img: 'images/prodact/مصباح أرضي أوركا.jpg', cat: 'إضاءة', name: 'مصباح أرضي أوركا', price: '1,200', old: '2,500 ', off: '20%', desc: 'مصباح أرضي بتصميم عصري وقاعدة معدنية متينة، إضاءة مريحة للعين تناسب أركان القراءة والجلوس.' },
    ...
    tv_tables: [
      { img: 'images/prodact/طاولة تلفزيون خشب مقاس 200 سم.png', cat: 'طاولة تلفزيون', name: 'طاولة تلفزيون خشب مقاس 200 سم', price: '464', old: '580', off: '20%', desc: 'طاولة تلفزيون بمقاس كبير 200 سم وأدراج تخزين واسعة، خشب متين يناسب صالات المعيشة الكبيرة.' },
